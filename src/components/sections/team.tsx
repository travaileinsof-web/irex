...
export function Team() {
 ...
 <div className="absolute top-32 right-10 h-72 w-72 rounded-full opacity-10 blur-2xl" style={{ background: "radial-gradient(circle, var(--gold), transparent 70%)" }} />
 ...
 <img src={teamAvatars[i % teamAvatars.length]} alt={m.name} loading="lazy" decoding="async" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
 {/* Gradient overlay */}
 ...
 <button className="flex h-9 w-9 items-center justify-center rounded-full bg-ivory/90 text-obsidian hover:bg-gold transition-colors">
