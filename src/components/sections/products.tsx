...
export function Products() {
 ...
 <div className="absolute top-20 right-10 h-72 w-72 rounded-full opacity-15 blur-2xl" style={{ background: "radial-gradient(circle, var(--gold), transparent 70%)" }} />
 ...
 {/* Product grid — pure CSS, no layout animations for perf */}
 ...
 <img src={productImages[i % productImages.length]} alt={item.name} loading="lazy" decoding="async" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
