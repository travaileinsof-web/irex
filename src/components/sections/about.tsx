...
import { Eye, Target, Gem, Leaf, Shield, Heart, Award, CheckCircle2, Loader2 } from "lucide-react";
...
export function About() {
  ...
  const { data: apiAbout, loading } = useFetch<any>("/api/about");
  
  // Use API data if available, fallback to hardcoded content
  const c = apiAbout ? apiAbout[lang] : content[lang].about;
