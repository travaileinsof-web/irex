  ...
  return (
    <div>
      ...
      <DeleteConfirmModal
        ...
        itemName={pendingDelete?.name || "this event"}
        itemType="event"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Field label="Type" required>
            ...
            >
              ...
              <option value="Sommet">Sommet</option><option value="Summit">Summit</option><option value="Formation">Formation</option><option value="Training">Training</option><option value="Conférence">Conférence</option><option value="Conference">Conference</option><option value="Workshop">Workshop</option>
            </Select>
          </Field>
