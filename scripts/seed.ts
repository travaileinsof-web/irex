...
async function main() {
  ...
  const categories = [
    ...
    { name: "Solutions SSE", nameEn: "SSE Solutions", icon: "shield", order: 2 },
  ...
  const products = [
    ...
    { name: "Logiciel de Surveillance SSE", nameEn: "SSE Monitoring Software", description: "Plateforme digitale de surveillance et gestion SSE en temps réel.", descriptionEn: "Real-time SSE monitoring and management digital platform.", price: 1200000, badge: "Nouveau", type: "software", categoryName: "Solutions Numériques", image: "https://sfile.chatglm.cn/images-ppt/a7122f749665.jpg" },
    ...
    { name: "Détecteur Multi-Gaz Portable", nameEn: "Portable Multi-Gas Detector", description: "Détecteur portable de gaz multiples pour sécurité minière.", descriptionEn: "Portable multi-gas detector for mining safety.", price: 680000, type: "product", categoryName: "Solutions SSE", image: "https://sfile.chatglm.cn/images-ppt/ad275eddf4ad.jpeg" },
  ];
  ...
  const projects = [
    ...
    { name: "Audit SSE Complexe Minier Kalia", nameEn: "Kalia Mining Complex SSE Audit", description: "Audit complet des standards SSE du complexe minier de Kalia.", descriptionEn: "Complete SSE standards audit of the Kalia mining complex.", sector: "SSE", year: "2024", status: "Livré", image: "https://sfile.chatglm.cn/images-ppt/ad275eddf4ad.jpeg", client: "Bellzone", location: "Kalia, Guinea" },
  ...
  const team = [
    ...
    { name: "Direction Technique", role: "Directrice des Opérations", roleEn: "Operations Director", expertise: "Exploitation • SSE", expertiseEn: "Operations • SSE", photo: "https://sfile.chatglm.cn/images-ppt/2dadb83f90c1.jpg" },
    { name: "Direction SSE", role: "Responsable Santé-Sécurité", roleEn: "Health-Safety Manager", expertise: "Environnement • Conformité", expertiseEn: "Environment • Compliance", photo: "https://sfile.chatglm.cn/images-ppt/9ce72928993d.jpeg" },
  ...
  const posts = [
    ...
    { title: "Standards SSE : comment dépasser les exigences internationales", titleEn: "SSE standards: exceeding international requirements", excerpt: "Retours d'expérience sur l'application des standards SSE.", excerptEn: "Feedback on applying SSE standards.", content: "Les standards SSE internationaux servent de base, mais les meilleures entreprises minières vont au-delà.", contentEn: "International SSE standards serve as a baseline, but the best mining companies go beyond.", category: "SSE", coverImage: "https://sfile.chatglm.cn/images-ppt/e6348a09b7be.jpg", author: "IREX Mining", readTime: "6 min" },
  ...
  const events = [
    ...
    { name: "Formation SSE Niveau 2", nameEn: "SSE Training Level 2", description: "Formation avancée SSE pour professionnels.", descriptionEn: "Advanced SSE training for professionals.", date: "08-10 Octobre 2026", location: "Matoto, Conakry", type: "Formation", image: "https://sfile.chatglm.cn/images-ppt/a1abd893bc83.jpg" },
  ...
  const jobs = [
    ...
    { title: "Spécialiste SSE", titleEn: "SSE Specialist", description: "Garant des standards SSE sur site minier.", descriptionEn: "Guarantor of SSE standards on mining site.", location: "Site Boké", type: "CDI", dept: "SSE" },
  ...
  // 11. Site stats
  const stats = [
    { key: "complianceRate", label: "Conformité SSE", labelEn: "SSE Compliance", value: 100, suffix: "%", icon: "shield", order: 1 },
