        ...
        <div className="grid grid-cols-2 gap-px overflow-hidden rounded-3xl border border-gold/20 bg-gold/20 lg:grid-cols-4">
          {c.items.map((stat, i) => (
            <Reveal key={i} delay={i * 0.1}>
              <div className="group relative flex flex-col items-center justify-center bg-emerald-deep/80 backdrop-blur-sm p-10 text-center transition-all duration-500 hover:bg-emerald-deep">
