  ...
  return (
    <div>
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="font-display text-3xl font-bold text-ivory">Categories</h1>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-obsidian/50">
                  ...
                  <th className="px-4 py-3 text-left text-[10px] uppercase tracking-wider text-muted-foreground">NameEn</th>
              ...
              <tbody>
                {filtered.map((item) => (
                  ...
                  <td className="px-4 py-3 text-sm text-ivory">{item.nameEn || "—"}</td>
