  ...
  return (
    <div>
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="font-display text-3xl font-bold text-ivory">Donation Tiers</h1>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-obsidian/50">
                  ...
                  <th className="px-4 py-3 text-left text-[10px] uppercase tracking-wider text-muted-foreground">Amount</th>
              ...
              <tbody>
                {filtered.map((item) => (
                  ...
                  <td className="px-4 py-3 text-sm text-ivory">{item.amount || "—"}</td>
      ...
      <DeleteConfirmModal
        ...
        itemName={pendingDelete?.title || "this donation tier"}
        itemType="donation tier"
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          <Field label="Amount (GNF)" required>
            <Input
              type="number"
              required
          ...
          <Field label="Perks (FR) - one per line" required>
            <Textarea
              required
              rows={3}
          ...
          <Field label="Perks (EN) - one per line" >
            <Textarea
