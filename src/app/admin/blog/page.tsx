  ...
  return (
    <div>
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="font-display text-3xl font-bold text-ivory">Blog Posts</h1>
      ...
      <DeleteConfirmModal
        ...
        itemName={pendingDelete?.title || "this blog post"}
        itemType="blog post"
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Field label="Content (FR) - Markdown" required>
            <Textarea
              required
              rows={3}
          ...
          <Field label="Content (EN) - Markdown" >
            <Textarea
