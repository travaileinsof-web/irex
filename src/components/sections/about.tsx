        ...
        <div className="mt-24 grid gap-6 md:grid-cols-2 lg:gap-8">
          <Reveal>
            <div className="group relative overflow-hidden rounded-3xl border border-gold/20 bg-gradient-to-br from-cream to-white p-10 card-lift">
              <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-gold/10 blur-3xl transition-opacity duration-500 group-hover:opacity-100" />
          ...
          <Reveal delay={0.1}>
            <div className="group relative overflow-hidden rounded-3xl border border-emerald/20 bg-gradient-to-br from-emerald-deep to-emerald p-10 card-lift">
              <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-emerald-light/20 blur-3xl transition-opacity duration-500 group-hover:opacity-100" />
              <div className="relative">
                <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-light/30 backdrop-blur-sm">
